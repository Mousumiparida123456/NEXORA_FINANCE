      ...
      <Link href={href}>
        <a
          className={cn(
            ...
            active
              ? theme === "dark"
                ? "bg-blue-500/15 text-blue-300 border-blue-500/20 font-semibold"
...
export function MobileNav() {
  ...
  return (
    <div
      className={cn(
        "md:hidden sticky top-0 z-50 border-b backdrop-blur",
        isDark
      ...
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-3">
        <Sheet>
          <SheetTrigger asChild>
            <button
              className={cn(
                ...
                isDark
                  ? "border-slate-800/70 bg-slate-900/60 text-slate-200 hover:bg-slate-900"
          ...
          <SheetContent
            side="left"
            className={cn(
              "w-[86vw] max-w-[320px] p-0 flex flex-col",
              isDark ? "bg-slate-950 border-slate-800/70 text-slate-50" : "bg-white border-slate-200 text-slate-950",
            )}
          >
            <div className={cn("flex items-center gap-3 px-4 py-4 border-b", isDark ? "border-slate-800/60" : "border-slate-200")}>
              <div className="h-9 w-9 flex-shrink-0 rounded-xl flex items-center justify-center shadow-md bg-blue-600 shadow-blue-500/20">
            ...
            <ScrollArea className="flex-1 px-3 py-3">
              <div className="space-y-5">
                <div>
                  <p className={cn("text-[10px] font-bold uppercase tracking-widest px-2 mb-1.5", isDark ? "text-slate-600" : "text-slate-400")}>
                    Main Menu
                  </p>
                ...
                <div className="pt-2 border-t border-slate-800/40">
                  ...
                  <SheetClose asChild>
                    <button
                      ...
                      className={cn(
                        "flex w-full items-center gap-3 rounded-xl border border-transparent px-3 py-2.5 transition-all hover:bg-rose-500/10 hover:text-rose-300",
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className={cn("text-sm font-bold truncate", isDark ? "text-slate-50" : "text-slate-950")}>
            {currentLabel}
          </p>
        </div>
