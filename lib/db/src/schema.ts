...
export const users = pgTable(
  ...
  (table) => ({
    ...
    emailRoleUniqueIdx: uniqueIndex("email_role_unique_idx").on(
      table.email,
      table.role,
    ),
  }),
...
export const userPreferences = pgTable(
  ...
  (table) => ({
    userUniqueIdx: uniqueIndex("user_preferences_user_id_unique").on(
      table.userId,
    ),
  }),
);
...
export const sentinelAuditLogs = pgTable(
  ...
  (table) => ({
    auditIdIdx: index("sentinel_audit_id_idx").on(
      table.auditId,
    ),

    txnIdIdx: index("sentinel_txn_id_idx").on(
      table.transactionId,
    ),
  }),
);
...
export const selectUserPreferencesSchema =
  createSelectSchema(userPreferences);

export const insertPlaidItemSchema =
  createInsertSchema(plaidItems);

export const selectPlaidItemSchema =
  createSelectSchema(plaidItems);

export const insertSentinelAuditLogSchema =
  createInsertSchema(sentinelAuditLogs);

export const selectSentinelAuditLogSchema =
  createSelectSchema(sentinelAuditLogs);
...
export type Account =
  z.infer<typeof selectAccountSchema>;
...
export type UserPreferences =
  z.infer<typeof selectUserPreferencesSchema>;

export type NewUserPreferences =
  z.infer<typeof insertUserPreferencesSchema>;

export type PlaidItem =
  z.infer<typeof selectPlaidItemSchema>;

export type NewPlaidItem =
  z.infer<typeof insertPlaidItemSchema>;

export type SentinelAuditLog =
  z.infer<typeof selectSentinelAuditLogSchema>;

export type NewSentinelAuditLog =
  z.infer<typeof insertSentinelAuditLogSchema>;